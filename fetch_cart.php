...
while($row = $res->fetch_assoc()){
    $ctr++;
    $getId2 = mysqli_query($con, "SELECT * FROM product WHERE pro_id = '".$row['cart_pro_id']."' ");
    ...
    <div class='card-body m-auto'>
        ...
        <p class='card-text'>Harga : ".$rowId2['pro_price']."</p>
        <p class='card-text'>Size : ".$rowId2['pro_size']."</p>
